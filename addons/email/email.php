...
class Email extends \AnsPress\Singleton {
	...
	protected function __construct() {
		...
		add_action( 'ap_form_options_features_email', array( $this, 'register_option' ) );
		add_action( 'ap_form_email_template', array( $this, 'register_email_template' ) );
		add_action( 'ap_all_options', array( $this, 'ap_all_options' ), 3, 2 );
