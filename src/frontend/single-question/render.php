...
<div <?php echo wp_kses_data( get_block_wrapper_attributes() ); ?> data-gutenberg-attributes="<?php echo esc_attr( wp_json_encode( $attributes ) ); ?>" data-post-id="<?php the_ID(); ?>">
	...
	<div class="wp-block-anspress-single-comments">
		<div class="wp-block-anspress-single-comment">
			<a class="wp-block-anspress-single-question-avatar" href="<?php ap_profile_link(); ?>">
				<?php ap_author_avatar( ap_opt( 'avatar_size_qquestion' ) ); ?>
			</a>
			<div class="wp-block-anspress-single-comment-content">
				Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam nec purus nec nunc tincidunt aliquam. Donec nec nunc tincidunt, ultricies nunc nec, ultricies nunc. Nullam nec purus nec nunc tincidunt aliquam. Donec nec nunc tincidunt, ultricies nunc nec, ultricies nunc.
			</div>
		</div>
	</div>
</div>
