	...
	<?php if(ap_has_activities()): ?>
		<div class="ap-notification-list">
			<?php while ( ap_activities() ) : ap_the_activity(); ?>
					<div id="ap-notification-<?php ap_activity_the_id(); ?>" class="ap-notification-item clearfix<?php //echo ap_notification_is_unread() ? ' unread' : ''; ?>">
						...
						<div class="ap-notification-btns ap-pull-right">
							<?php if(ap_notification_is_unread()): ?>
								<a class="ap-btn ap-btn-markread ap-tip <?php echo ap_icon('check'); ?>" href="#" data-action="ap_markread_notification" data-query="<?php echo 'id='.ap_activity_id().'&ap_ajax_action=markread_notification&__nonce='.wp_create_nonce('ap_markread_notification_'.ap_activity_id()); ?>" title="<?php _e('Mark as read', 'ap'); ?>"></a>
							<?php endif; ?>
							<a class="ap-btn ap-btn-delete ap-tip" href="#" data-action="ap_delete_notification" data-query="<?php echo 'id='.ap_activity_id().'&ap_ajax_action=delete_notification&__nonce='.wp_create_nonce('delete_notification'); ?>" title="<?php _e('Delete notificaton', 'ap'); ?>"><?php echo ap_icon('trashcan', true); ?></a>
