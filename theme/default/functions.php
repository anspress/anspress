...
function init_scripts_front(){
	//if(is_anspress()){
		...
		wp_enqueue_script( 'bootstrap-js', ap_get_theme_url('js/bootstrap.min.js'), 'jquery', AP_VERSION);
		...
		wp_enqueue_style( 'bootstrap.dropdown-css', ap_get_theme_url('css/bootstrap.min.css'), array(), AP_VERSION);
