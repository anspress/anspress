<?php  //[STAMP] 036a39a7061ae69388e19df7f5af0044
...
trait WpunitTesterActions
{
     ...
     *
     *
     * @see \Helper\AnsPressCommon::logout()
     */
     ...
     *
     *
     * @see \Helper\AnsPressCommon::setRole()
     */
     ...
     *
     *
     * @see \Helper\AnsPressCommon::go_to_question()
     */
    public function go_to_question($id) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('go_to_question', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\AnsPressCommon::insert_question()
     */
    public function insert_question($title = "", $content = "", $author = 0) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('insert_question', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\AnsPressCommon::insert_answer()
     */
    public function insert_answer($title = "", $content = "", $author = 0) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('insert_answer', func_get_args()));
    }
	 ...
	 * @param array $a_args
	 * @return array
     * @see \Helper\AnsPressCommon::insert_answers()
     */
    public function insert_answers($q_args = [], $a_args = [], $answer_num = 1) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('insert_answers', func_get_args()));
    }
}
