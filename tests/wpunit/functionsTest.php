...
class functionsTest extends \Codeception\TestCase\WPTestCase
{
    ...
    public function testApBasePageSlug(){
        $id = $this->factory->post->create([ 'post_type' => 'page', 'post_name' => 'qqqqslug' ]);
        ap_opt('base_page', $id);
    ...
    public function testApBasePageLink(){
        ...
        $id = $this->factory->post->create([ 'post_type' => 'page', 'post_name' => 'qqqqslugqq' ]);
        ap_opt('base_page', $id);
    ...
    public function testIsAnsPress() {
        ...
        $id = $this->factory->post->create(['post_type' => 'page', 'post_name' => 'askksk23324', 'post_title' => 'ask page']);
        ap_opt('ask_page', $id);
    ...
    public function testIsAsk(){
        ...
        $id = $this->factory->post->create(['post_type' => 'page', 'post_name' => 'asksssd3432s', 'post_title' => 'ask page']);
        ap_opt('ask_page', $id);
    ...
    public function testApPostEditLink(){
        ...
        $this->assertEquals( ap_get_link_to( 'ask' ) . '?id=' . $id->q . '&__nonce=' . $nonce, ap_post_edit_link( $id->q ) );$nonce = wp_create_nonce( 'edit-post-' . $id->a );
    ...
    public function testSanitizeCommaDelimited(){
        ...
        $this->assertEquals( '"dsfsdf??","function(){","sdsd","sdsdsds86789"', sanitize_comma_delimited( array(
            'dsfsdf<>??',
            'function(){',
            ',,,""sdsd',
            '\'sdsdsds86789',
    ...
    public function testApFormAllowedTags(){
        ...
        $this->assertArraySubset( [ 'style' => array(
            'align' => true,
        ), 'title' => true ] , $tags['p']);
        ...
        $this->assertArraySubset( [ 'href' => true, 'title' => true ] , $tags['a'] );
