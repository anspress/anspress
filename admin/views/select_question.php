		...
		<div id="similar_suggestions">
			...
			<?php if ( $questions->have_questions() ) : ?>
				...
				<div class="ap-similar-questions">
					<?php
					while ( $questions->have_questions() ) { $questions->the_question();
						echo '<div class="ap-q-suggestion-item clearfix">';
						echo '<a class="select-question-button button button-primary button-small" href="' . add_query_arg( array( 'post_type' => 'answer', 'post_parent' => get_the_ID() ), admin_url( 'post-new.php' ) ) . '">' . esc_attr__( 'Select', 'anspress-question-answer' ) . '</a>';
