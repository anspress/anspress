...
<?php
	...
	public function get_posts_counts() {
		global $wp_query;
		$counts        			= ap_moderate_posts_count();
	...
	public function posts_data() {
        ...
        $query = "SELECT p.*, v.userid as vote_user, v.value as vote_value, v.note as vote_note, v.voted_on FROM $wpdb->posts p INNER JOIN ".$wpdb->prefix."ap_vote v ON p.ID = v.actionid WHERE (post_type = 'answer' OR post_type = 'question') AND post_status = '$status' AND v.type='flag' ";
