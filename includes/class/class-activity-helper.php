...
class Activity_Helper {
	...
	private static function hooks() {
		add_action( 'before_delete_post', array( 'AnsPress\Activity_Helper', '_before_delete' ) );
		add_action( 'delete_comment', array( 'AnsPress\Activity_Helper', '_delete_comment' ) );
		add_action( 'delete_user', array( 'AnsPress\Activity_Helper', '_delete_user' ) );
		add_action( 'ap_ajax_more_activities', array( 'AnsPress\Activity_Helper', '_ajax_more_activities' ) );
	}
