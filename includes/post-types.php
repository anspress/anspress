...
class AnsPress_PostTypes {
	...
	public static function init() {
		...
		add_action( 'init', array( 'AnsPress_PostTypes', 'register_question_cpt' ), 0 );
		add_action( 'init', array( 'AnsPress_PostTypes', 'register_answer_cpt' ), 0 );
		add_action( 'post_type_link', array( 'AnsPress_PostTypes', 'post_type_link' ), 10, 4 );
		add_filter( 'post_type_archive_link', array( 'AnsPress_PostTypes', 'post_type_archive_link' ), 10, 2 );
		add_filter( 'post_updated_messages', array( 'AnsPress_PostTypes', 'post_updated_messages' ), 10, 1 );
		add_filter( 'bulk_post_updated_messages', array( 'AnsPress_PostTypes', 'bulk_post_updated_messages' ), 10, 2 );
	}
