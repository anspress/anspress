...
class AnsPress_Hooks {
	...
	public static function init() {
			...
			add_action( 'delete_comment', array( 'AnsPress_Hooks', 'comment_trash' ) );
			add_action( 'edit_comment', array( 'AnsPress_Hooks', 'edit_comment' ) );
			add_action( 'ap_publish_comment', array( 'AnsPress_Hooks', 'publish_comment' ) );
			add_action( 'ap_unpublish_comment', array( 'AnsPress_Hooks', 'unpublish_comment' ) );
			...
			add_filter( 'nav_menu_css_class', array( 'AnsPress_Hooks', 'fix_nav_current_class' ), 10, 2 );
			...
			// Subscriptions.
			add_action( 'ap_after_new_question', array( 'AnsPress_Hooks', 'question_subscription' ), 10, 2 );
			add_action( 'ap_after_new_answer', array( 'AnsPress_Hooks', 'answer_subscription' ), 10, 2 );
			add_action( 'ap_new_subscriber', array( 'AnsPress_Hooks', 'new_subscriber' ), 10, 4 );
			add_action( 'ap_delete_subscribers', array( 'AnsPress_Hooks', 'delete_subscribers' ), 10, 2 );
			add_action( 'ap_delete_subscriber', array( 'AnsPress_Hooks', 'delete_subscriber' ), 10, 3 );
			add_action( 'before_delete_post', array( 'AnsPress_Hooks', 'delete_subscriptions' ) );
			add_action( 'ap_publish_comment', array( 'AnsPress_Hooks', 'comment_subscription' ) );
			add_action( 'deleted_comment', array( 'AnsPress_Hooks', 'delete_comment_subscriptions' ), 10, 2 );
