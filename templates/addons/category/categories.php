						...
						<div class="ap-category-item">
							<div class="ap-cat-img-c">
								...
								<span class="ap-term-count">
									<?php
										printf(
											_n( '%d Question', '%d Questions', $category->count, 'anspress-question-answer' ), (int) $category->count
										);
									?>
								</span>
							...
							<div class="ap-term-title">
								...
								<?php if ( $sub_cat_count > 0 ) : ?>
									<span class="ap-sub-category">
										<?php
											printf(
												_n( '%d Sub category', '%d Sub categories', $sub_cat_count, 'anspress-question-answer' ), (int) $sub_cat_count
											);
										?>
									</span>
								<?php endif;?>
